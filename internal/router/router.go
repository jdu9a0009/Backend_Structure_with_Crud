...
func (r Router) Init() error {
	...
	r.Post("/api/v1/user/upload-avatar/:id", userController.UploadUserAvatar, middleware.Authenticate(r.auth))
	r.Get("/api/v1/get/me", userController.GetMe, middleware.Authenticate(r.auth))
